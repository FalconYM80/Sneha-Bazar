...
const CONFIG = {
  ...
  useMediumConfidenceSheet: true // Use the dedicated "Medium Confidence" sheet
};
...
const importProducts = async () => {
  try {
    ...
    console.log('MEDIUM-CONFIDENCE PRODUCT IMPORT SCRIPT');
    console.log('='.repeat(60));
    ...
    let sheetName;
    if (CONFIG.useMediumConfidenceSheet && workbook.SheetNames.includes('Medium Confidence')) {
      sheetName = 'Medium Confidence';
    ...
    console.log(`Medium Confidence rows found: ${stats.mediumConfidenceRows}`);
