    ...
    <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <span className="inline-block mt-2 bg-blue-50 text-blue-600 text-[10px] font-bold px-2.5 py-0.5 rounded-full">Pickup Only</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-4 flex items-center gap-4 border border-gray-100 shadow-sm">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-900 font-extrabold text-xl">{calculatePickupTime(cartCount)}</p>
        </div>
      </div>
