      ...
      <div className="px-6 py-4 flex flex-col flex-1">
        ...
        <div className="flex bg-gray-100 rounded-xl p-1 mb-5">
          {(['phone', 'email'] as const).map(tab => (
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-sm font-semibold transition-all ${loginTab === tab ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500'}`}
            >
        ...
        <div className="space-y-4 mb-5">
          ...
          <div className="flex justify-end">
            <button className="text-gray-600 text-sm font-semibold">Forgot Password?</button>
          </div>
        </div>
        ...
        <button className="w-full bg-white border-2 border-gray-300 text-gray-700 py-3.5 rounded-2xl font-semibold text-sm flex items-center justify-center gap-2 hover:bg-[#F8F9FA] transition-colors">
        ...
        <p className="text-center text-gray-400 text-sm mt-6">
          {"New to Sneha Bazar? "}
          <button onClick={() => onSetScreen('register')} className="text-gray-700 font-bold hover:text-gray-900 transition-colors">Create Account</button>
        </p>
      </div>
    </div>
  )
